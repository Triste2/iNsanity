...
client.on('message', message => {
    ...
    if(message.content.includes('discord.gg')){
      if(!message.member.hasPermission('ADMINISTRATOR'))
        message.delete()
    return message.reply(`** :rofl:! ممنوع النشر ي حلو !:rofl: **`)
    }
});
...
✧ ( ipublic ) - ( لإظهار قائمة الاوامر العامة ) ✧

✧ ( iadmin ) - ( لإظهار قائمة الاوامر الادارية ) ✧

✧ ( igames ) - ( لإظهار قائمة الالعاب ) ✧
...
✧ ( iinvites ) - ( لمعرفة عدد دعواتك ) ✧

✧ ( iping ) - ( لمعرفة سرعة البوت ) ✧

✧ ( iavatar ) - (  لرؤية افتار حسابك ) ✧

✧ ( iserver ) - ( لمعرفة معلومات السيرفر ) ✧

✧ ( رابط ) - ( رابط لـ 100 شخص لمدة 24 ساعة ) ✧

✧ ( iroll ) - ( القرعة ) ✧

✧ ( iinfo ) - ( معلومات البوت ) ✧

✧ ( icount ) - ( عدد أعضاء السيرفر ) ✧ 

✧ ( idiscrim ) - ( لتغير التاق ) ✧
...
✧ ( ibc1 ) - ( برودكاست مع ايمبد ومطور ) ✧

✧ ( ibc2 ) - ( برودكاست بدون ايمبد مع منشن ومع عدد المستلمين ) ✧

✧ ( ibc3 ) - ( برودكاست للأونلاين مع منشن ) ✧

✧ ( iall ) - ( لسحب جميع الاعضاء لرومك الصوتي ) ✧
...
✧ ( لعبة-كت-تويت ) - ( لعبة كت تويت ) ✧

✧ ( لعبة-صراحة ) - ( لعبة صراحة ) ✧

✧ ( لعبة-الزواج ) - ( لعبة الزواج ) ✧
...
message.channel.send(`${user} لقد دعوت  ${inviteCount} دعوة`);
});
  }
});
...
client.on('message', message => {
                        ...
                        if (message.content.startsWith('iping')) {
                            if(!message.channel.guild) return;
...
message.channel.sendEmbed(embed)
	...
	client.on('message', message => {
if (message.content.startsWith("ikick")) {
    var mention = message.mentions.members.first();
    if(!mention) return message.channel.send("وين المنشن؟");

    mention.kick("بواسطة : " + message.author.tag);
    
    message.channel.send(" تم طرد العضو : " + mention.tag );
};
});
...
if (message.content.startsWith("iban")) {
    ...
    mention.ban("بواسطة : " + message.author.tag);
    
    message.channel.send("تم تبنيد العضو : " + mention.tag );
};
});
...
client.on('message', function(message) {
 ...
 client.on('message', message => {
   if (message.content.startsWith("لعبة-كت-تويت")) {
                if(!message.channel.guild) return message.reply('** This command only for servers**');
  var embed = new Discord.RichEmbed()
  .setColor('RANDOM')
   .setThumbnail(message.author.avatarURL) 
...
const Sra7a = [
  ...
  client.on('message', message => {
if (message.content.startsWith('لعبة-صراحة')) {
    if(!message.channel.guild) return message.reply('** This command only for servers **');
...
client.on("message", message => {
  ...
  const embed = new Discord.RichEmbed()
    .setColor(0x00AE86)
    .setTimestamp()
    .addField('الأستعمال:', 'imute / iunmute')
...
if (message.member.voiceChannel == null) return message.channel.send(`**الرجاء الدخول لروم صوتي**`)
 ...
 message.channel.send(`**تم سحب جميع الأعضاء إليك**`)
    ...
    if (message.content.match(/([A-Z0-9]|-|_){24}\.([A-Z0-9]|-|_){6}\.([A-Z0-9]|-|_){27}|mfa\.([A-Z0-9]|-|_){84}/gi)) {
        if(!message.guild.members.get(client.user.id).hasPermission('MANAGE_MESSAGES')) return message.channel.send('**احتاج ذا البرمشن \`MANAGE_MESSAGE\`لحذف التوكنات**')
        message.delete();
        message.reply(`رسلت التوكن بالغلط؟ لاتخاف حذفتهه م عليك (:`);
        return;
    }
...
`);
   ...
   client.on('message', message => {
      if(message.content.startsWith ("لعبة-الزواج")) {
      if(!message.channel.guild) return message.reply('** This command only for servers **')
...
//                         The Official Bot By HassaN                                        // الترحيب 
...
client.on('guildMemberAdd', member => {
    ...
    .setTitle(`** زائر جديد **`)
    .setDescription(`** Welcome To iNsanity Server **`)
    .addField(' **:bust_in_silhouette: أنت العضو رقم **',`**[ ${member.guild.memberCount} ]**`,true)
    .setColor('RANDOM')
    .setFooter('The Official iNsanity ', 'https://i.imgur.com/UyMIlvE.jpg')
...
//                               The Official Bot By HassaN                          //      اللوق           
  ...
  client.on("guildMemberAdd", function(member) {
    const wc = member.guild.channels.find("name", "log")
        ...
        .addField(":arrow_lower_right: , زائر جديد ",`** Welcome To iNsanity Server **`)
        .setTimestamp()
...
client.on("guildMemberRemove", function(member) {
    const wc = member.guild.channels.find("name", "log")
        ...
        .setColor('RANDOM')
        .setAuthor(member.user.tag, member.user.avatarURL)
        .addField(":arrow_upper_left: , الزائر طلع ",`** We Will Miss You **`)
        .setTimestamp()
        return wc.sendEmbed(embed);
});
